	...
	public class Weapon {
		...
		*/
		...
		public static const BUFF_LIST:Array = [ 	new Buff('none', 'none', 'none', 0, function(src:BattleCharacter, trg:BattleCharacter):void { }),
													...
													new Buff('freeze', 'Freeze', 'Has a chance to freeze the enemy, disabling their attack for a turn.', 1, function(src:BattleCharacter, trg:BattleCharacter):void { if (Math.random() < 0.3) src.tempAttackStat = -src.attackStat; } ),
													...
													new Buff('freeze', 'Deep Freeze', 'Has a chance to freeze the enemy, disabling their attack for 2 turns.', 2, function(src:BattleCharacter, trg:BattleCharacter):void { if (Math.random() < 0.6) src.tempAttackStat = -src.attackStat; }),
